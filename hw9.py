# Write a Python function treasure_hunt that takes as arguments positive integers m, n and p and returns the number of valid 
# configurations of the m×n grid world that follows the following rules.
...
# The inputs m and n will satisfy 1≤m,n≤50, and p will be a nonnegative integer less than or equal to mn−1. You may 
# 	assume the code will never be run where there are no valid configurations at all.
